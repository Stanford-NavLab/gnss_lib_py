...
from gnss_lib_py.algorithms.multi_gnss import compute_sv_gps_from_brdcst_eph
...
def fixture_sp3_path(root_path):
    ...
    Notes
    -----
    Downloaded the relevant .sp3 files from either CORS website [2]_ or
    CDDIS website [3]_
